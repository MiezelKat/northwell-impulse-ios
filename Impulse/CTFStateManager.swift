...
class CTFStateManager: NSObject, CTFAppStateProtocol {
...
//        CTFStudyConstants.NotificationIdentifiers.forEach({self.cancelNotification(withIdentifier: $0)})
//    }
//    
...
//        self.cancelNotification(withIdentifier: CTFStudyConstants.kMorningNotificationIdentifer)
//        self.cancelNotification(withIdentifier: CTFStudyConstants.kMorningNotificationIdentifer2nd)
//        //Set notification
//        
...
//            self.setNotification(forIdentifier: CTFStudyConstants.kMorningNotificationIdentifer, initialFireDate: fireDate, text: CTFStudyConstants.kMorningNotificationText)
//            //set second notification
//            self.setNotification(forIdentifier: CTFStudyConstants.kMorningNotificationIdentifer2nd, initialFireDate: fireDate.addingTimeInterval(CTFStudyConstants.kSecondaryNotificationDelay), text: CTFStudyConstants.kMorningNotificationText)
//        }
//    }
//    
...
//        //cancel notification if exists
//        self.cancelNotification(withIdentifier: CTFStudyConstants.kEveningNotificationIdentifer)
//        self.cancelNotification(withIdentifier: CTFStudyConstants.kEveningNotificationIdentifer2nd)
//        //Set notification
...
//            let fireDate = self.getNotificationFireDate(timeComponents: dateComponents as NSDateComponents, latestCompletion: lastCompletion) {
//            self.setNotification(forIdentifier: CTFStudyConstants.kEveningNotificationIdentifer, initialFireDate: fireDate, text: CTFStudyConstants.kEveningNotificationText)
//            //set second notification
//            self.setNotification(forIdentifier: CTFStudyConstants.kEveningNotificationIdentifer2nd, initialFireDate: fireDate.addingTimeInterval(CTFStudyConstants.kSecondaryNotificationDelay), text: CTFStudyConstants.kEveningNotificationText)
//        }
//    }
//    
...
//        //21 day notification
//        //cancel notification if exists
//        self.cancelNotification(withIdentifier: CTFStudyConstants.k21DayNotificationIdentifier)
//        self.cancelNotification(withIdentifier: CTFStudyConstants.k21DayNotificationIdentifier2nd)
//        
//        //Set notification
...
////        CTFKeychainHelpers.setKeychainObject(dateComponents as NSDateComponents, forKey: CTFStudyConstants.kMorningSurveyTime)
//        
//        //set notifications
...
//        let lastCompletion: Date? = CTFKeychainHelpers.getKeychainObject(CTFStudyConstants.kLastMorningSurveyCompleted) as? Date
//        
